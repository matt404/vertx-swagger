...
public class MainApiVerticle extends AbstractVerticle {
    ...
    public void deployVerticles(Future<Void> startFuture) {
        ...
        vertx.deployVerticle("io.swagger.verticle.PetApiVerticle", res -> {
            if (res.succeeded()) {
        ...
        vertx.deployVerticle("io.swagger.verticle.StoreApiVerticle", res -> {
            if (res.succeeded()) {
        ...
        vertx.deployVerticle("io.swagger.verticle.UserApiVerticle", res -> {
            if (res.succeeded()) {
