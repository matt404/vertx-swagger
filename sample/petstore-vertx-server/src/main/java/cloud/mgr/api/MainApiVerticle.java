...
public class MainApiVerticle extends AbstractVerticle {
    ...
    public void deployVerticles(Future<Void> startFuture) {
        ...
        vertx.deployVerticle("cloud.mgr.api.verticle.PetApiVerticle", res -> {
            if (res.succeeded()) {
        ...
        vertx.deployVerticle("cloud.mgr.api.verticle.StoreApiVerticle", res -> {
            if (res.succeeded()) {
        ...
        vertx.deployVerticle("cloud.mgr.api.verticle.UserApiVerticle", res -> {
            if (res.succeeded()) {
